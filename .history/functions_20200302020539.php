...
function this_scripts_styles() {
	...
	wp_enqueue_style('Google', 'https://fonts.googleapis.com/css?family=Shadows+Into+Light%7CLibre+Franklin:200,300,400,600,700', array(), '1.0.0');
	...
	wp_enqueue_style('style', get_stylesheet_uri(), array('Google', 'reset', 'pushyCSS'), '1.0.12');
