...
<body>
  ...
  <footer class="page-footer">
    ...
    <script src=" <?php gettempldiu ?> js/plugins/rdVideoPlayer.js" defer></script>
    <script src=" <?php gettempldiu ?> js/plugins/textRotator.js" defer></script>
    <script src=" <?php gettempldiu ?> js/script.js" defer></script>
