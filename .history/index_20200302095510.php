  ...
  <div class="text-center page">
    ...
    <section class="section swiper-container swiper-slider swiper-container-horizontal" id="Inicio" data-loop="false"
      ...
      <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
        ...
        <div class="swiper-slide" data-slide-bg="<?php echo get_template_directory_uri() ?>/img/home-slider-03.jpg"
          style="background-image: url(<?php echo get_template_directory_uri() ?>/index_filex/home-slider-03.jpg;); background-size: cover; width: 1343px;">
          <div class="swiper-slide-caption">
            <div class="container container-wide">
      ...
      <div class="container container-wide">
        ...
        <div class="row justify-content-center">
          <div class="col-xxl-6 col-xl-7 col-lg-8">
            <div><img src="<?php echo get_template_directory_uri() ?>/img/home-11.png" alt="" width="870" height="59"></div>
    ...
    <section class="section-80 section-md-90 section-lg-140 bg-gray-lighter" id="Costum">
      <div class="container container-wide container-spacing-30">
        ...
        <div class="row row-50 row-lg-90">
          <div class="col-xl-3 col-lg-4 col-md-6"><a class="thumbnail-type-2" href="">
              <figure><img src="<?php echo get_template_directory_uri() ?>/img/.jpg" alt="" width="350" height="350"></figure>
              <div class="caption">
        ...
        (function () {
            ...
            if (b) {
                ...
                for (c = 0; c < d.length; c++) {
                    var a = d[c];
                    0 == a.href.indexOf("") && (0 < a.href.indexOf("?") ? a.href = a.href + "\x26aff\x3d" + b : a.href =
                        a
                        .href + "?aff\x3d" + b)
                }
            }
            ...
            if (b && e)
                for (b = b.split("\x26")[0], d = document.querySelectorAll("a"), c = 0; c < d.length; c++) a = d[c],
                    0 == a
                    .href.indexOf("") &&
                    (a.href = "" + e)
        })();
