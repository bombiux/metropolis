...
<body>
  ...
  <div style="display: block; width: 100%;padding: 5px 0;background: url(https://fundeu.es/coronavirus-recomendaciones-lenguaje/images/covid.png) left no-repeat;">    <!-- <div>ola k ase</div> -->
        <div style="
    display: flex;
