...
<body>
  ...
  <div style="display:block;width:100%;padding:5px 0;background:url(https://fundeu.es/coronavirus-recomendaciones-lenguaje/images/covid.png) left no-repeat">
    <?php $query=new WP_Query('post_type=covid');while($query->have_posts()):$query->the_post();?>
    <div style="display:flex;flex-direction:column;width:;margin: auto;text-align: center;font-weight: bold;">
      ...
      <div style="display:flex;justify-content:center">
        <div style="display: flex;background-color: #e2e2e2;">
          ...
          <div style="width: 34px;background-color: #0000001c;"><?php echo get_field('confirmados');?></div>
        </div>
        <div style="display: flex;background-color: #ff8d8d;color: white;">
          <div style="width: 200px;">Curados</div>
          <div style="width: 34px;background-color: #00000033;"><?php echo get_field('curados');?></div>
        </div>
        <div style="display: flex;background-color: #ff8d8d;color: white;">
          <div style="width: 200px;">Fatales</div>
          <div style="width: 34px;background-color: #00000033;"><?php echo get_field('mortales');?></div>
        </div>
      </div>
    </div>
    <?php endwhile; wp_reset_postdata();?>
    <div style="display: block; width: 100%;padding: 5px 0;background: url(https://fundeu.es/coronavirus-recomendaciones-lenguaje/images/covid.png) left no-repeat;">
        <div style="display: flex;flex-direction: column;width: 235px;margin: auto;text-align: center;font-weight: bold;">
      <div style="text-transform: uppercase;">Nicaragua</div>
      <div style="display: flex;justify-content: center;">
...
">Infectados</div>
        ...
        <div style="display: flex;flex-direction: column;color: #1bb700;">
          <div style="">Curados</div>
          <div style=""></div>
        </div>
        <div style="display: flex;flex-direction: column;color: black;">
          <div style="">Fatales</div>
          <div style="">0</div>
        </div>
      </div>
    </div>
