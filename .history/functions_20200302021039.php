...
function this_scripts_styles() {
	...
	wp_enqueue_style('bootsrap', get_template_directory_uri() . '/css/bootstrap.css', array(), '0.0.6');
	wp_enqueue_style('style', get_stylesheet_uri(), array('Google-Fonts', 'bootsrap', 'pushyCSS'), '1.0.12');
