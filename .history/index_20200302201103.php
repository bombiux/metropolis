...
<body>
  ...
  <div class="text-center page">
        ...
        <nav class="rd-navbar rd-navbar-default rd-navbar-original rd-navbar-static rd-navbar--is-stuck"
          ...
          <div class="rd-navbar-inner">
            ...
            <div class="rd-navbar-panel">
              ...
              <!-- RD Navbar Brand-->
              <div class="rd-navbar-brand"><a class="brand-name" href="index.html"><img src="<?php echo get_template_directory_uri() ?>/img/logo.png" alt=""
    ...
    <section class="section swiper-container swiper-slider swiper-container-horizontal" id="Inicio" data-loop="false"
      ...
      <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
        <div class="swiper-slide-video swiper-slide swiper-slide-active" data-slide-bg="<?php echo get_template_directory_uri() ?>/img/home-slider-01.jpg"
            ...
            <div class="container container-wide">
              <div class="row justify-content-lg-between justify-content-center">
                ...
                <div class="col-md-9 col-xl-7 col-lg-6 video-caption-wrapper">
                  <div class="video-caption"><img class="video-caption-overlay" src="<?php echo get_template_directory_uri() ?>/img/home.png" alt="">
                    <!-- RD Video-->
                    <div class="rd-video play-on-scroll rd-video-player" data-rd-video-path="<?php echo get_template_directory_uri() ?>/img/managua">
                      <div class="rd-video-wrap">
                        <div class="rd-video-preloader"></div>
                        <video style="visibility: visible; opacity: 1;">
                          <source type="video/mp4" src="<?php echo get_template_directory_uri() ?>/img/managua.mp4"></video>
        ...
        <div class="swiper-slide swiper-slide-next" data-slide-bg="<?php echo get_template_directory_uri() ?>/img/home-slider-02.jpg"
      ...
      <div class="container container-wide container-spacing-30">
        ...
        <div class="row row-50 row-lg-90">
          <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;"><a
              ...
              <figure><img src="<?php echo get_template_directory_uri() ?>/img/BarriosManagua.jpg" alt="" width="420" height="300"></figure>
              <div class="caption">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;"><a
              class="thumbnail-type-1" href="">
              <figure><img src="<?php echo get_template_directory_uri() ?>/img/negocio.jpg" alt="" width="420" height="300"></figure>
              <div class="caption">
                <div class="caption-inner">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;"><a
              class="thumbnail-type-1" href="">
              <figure><img src="<?php echo get_template_directory_uri() ?>/img/arbolito.jpg" alt="" width="420" height="300"></figure>
              <div class="caption">
                <div class="caption-inner">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;"><a
              class="thumbnail-type-1" href="">
              <figure><img src="<?php echo get_template_directory_uri() ?>/img/pjapones.jpeg" alt="" width="420" height="300"></figure>
              <div class="caption">
                <div class="caption-inner">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;"><a
              ...
              <figure><img src="<?php echo get_template_directory_uri() ?>/img/1971.jpg" alt="" width="420" height="300"></figure>
              <div class="caption">
                <div class="caption-inner">
      ...
      <div class="container container-wide container-spacing-30">
        ...
        <div class="row row-50 row-lg-90">
          <div class="col-xl-3 col-lg-4 col-md-6"><a class="thumbnail-type-2" href="">
              <figure><img src="<?php echo get_template_directory_uri() ?>/img/lago.jpg" alt="" width="350" height="350"></figure>
              <div class="caption">
                <div class="caption-title">EL Lago</div>
              </div>
            </a></div>
          <div class="col-xl-3 col-lg-4 col-md-6"><a class="thumbnail-type-2" href="">
              <figure><img src="<?php echo get_template_directory_uri() ?>/img/lagu.jpg" alt="" width="350" height="350"></figure>
              <div class="caption">
                <div class="caption-title">Las Lagunas</div>
              </div>
            </a></div>
          <div class="col-xl-3 col-lg-4 col-md-6"><a class="thumbnail-type-2" href="">
              <figure><img src="<?php echo get_template_directory_uri() ?>/img/xlag.jpg" alt="" width="350" height="350"></figure>
              <div class="caption">
                <div class="caption-title">Xolotlan transformacion</div>
              </div>
            </a></div>
          <div class="col-xl-3 col-lg-4 col-md-6"><a class="thumbnail-type-2" href="">
              <figure><img src="<?php echo get_template_directory_uri() ?>/img/met.jpg" alt="" width="350" height="350"></figure>
              <div class="caption">
                <div class="caption-title">Metropolis</div>
              </div>
            </a></div>
          <div class="col-xl-3 col-lg-4 col-md-6"><a class="thumbnail-type-2" href="">
              <figure><img src="<?php echo get_template_directory_uri() ?>/img/coma.jpg" alt="" width="350" height="350"></figure>
              <div class="caption">
      ...
      <div class="container container-wide">
        <div class="row align-items-center justify-content-center justify-content-lg-between">
          <div class="col-sm-7 col-md-5 col-lg-4 col-xxl-4 image-wrapper-3 text-xl-right d-none d-sm-block wow fadeInUp"
            style="visibility: hidden; animation-name: none;"><img class="image__item" src="<?php echo get_template_directory_uri() ?>/img/emp.jpg" alt=""></div>
    ...
    <section class="section-80 section-md-90 section-lg-140 bg-gray-lighter" id="Costum">
      <div class="container container-wide container-spacing-30">
        ...
        <div class="row row-50 row-lg-90">
          <div class="col-xl-3 col-lg-4 col-md-6"><a class="thumbnail-type-2" href="">
              <figure><img src="<?php echo get_template_directory_uri() ?>/img/emp.jpg" alt="" width="350" height="350"></figure>
              <div class="caption">
  ...
  <footer class="page-footer">
    ...
    <script src="https://cdn.jsdelivr.net/gh/sksmatt/UItoTop-jQuery-Plugin@master/js/jquery.ui.totop.min.js" defer></script>
    <script src="https://cdn.jsdelivr.net/gh/ZemezPlugins/rd-navbar@master/dist/js/jquery.rd-navbar.min.js" defer></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/Swiper/3.4.2/js/swiper.jquery.min.js" integrity="sha256-Pl63iFzVinaVFc3QqrQvq3DimF1feP6Wqekm5jTabXo=" crossorigin="anonymous"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/wow/1.1.2/wow.min.js" integrity="sha256-z6FznuNG1jo9PP3/jBjL6P3tvLMtSwiVAowZPOgo56U=" crossorigin="anonymous"></script>
    <script src=" <?php get_template_directory_uri(); ?> js/plugins/rdVideoPlayer.js" defer></script>
    <script src=" <?php get_template_directory_uri(); ?> js/plugins/textRotator.js" defer></script>
    <script src=" <?php get_template_directory_uri(); ?> js/script.js" defer></script>
