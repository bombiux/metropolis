...
function this_scripts() {
	...
	wp_enqueue_script('rdVideoPlayer', get_template_directory_uri() . '/js/plugins/rdVideoPlayer.js', array('jQuery'), '1.0.1', true);
	wp_enqueue_script('textRotator', get_template_directory_uri() . '/js/plugins/textRotator.js', array('jQuery'), '0.2.1', true);
	wp_enqueue_script('script', get_template_directory_uri() . '/js/script.js', array('jQuery', 'cMigrate', 'easing', 'uiToTop', 'rdnavbar', 'swiper', 'wow', 'rdvideoPlayer', 'textRotator'), '0.0.1', true);
