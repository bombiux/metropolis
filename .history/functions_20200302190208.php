...
function this_scripts() {
	...
	wp_enqueue_script('script', get_template_directory_uri() . '/js/script.js', array('jquery', 'migrate', 'easing', 'uiToTop', 'rdnavbar', 'swiper', 'wow', 'rdvideoPlayer', 'textRotator'), '0.0.1', true);
