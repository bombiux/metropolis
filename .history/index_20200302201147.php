...
<body>
  ...
  <footer class="page-footer">
    ...
    <script src=" <?php echoget_template_directory_uri(); ?> /js/plugins/textRotator.js" defer></script>
    <script src=" <?php echoget_template_directory_uri(); ?> /js/script.js" defer></script>
