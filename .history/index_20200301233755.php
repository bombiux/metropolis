...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <meta charset="utf-8"><script src="https://code.iconify.design/1/1.0.3/iconify.min.js"></script>
    <script type="text/javascript" async="" src="js/ec.js"></script><script type="text/javascript" async="" src="js/analytics.js"></script><script async="" src="js/gtm.js"></script><script type="text/javascript" async="" src="js/ga.js"></script><script src="js/3ts2ksMwXvKRuG480KNifJ2_JNM.js"></script><script src="js/4o300efCt-CXoq1JEC-sVReFz48.js"></script><link rel="icon" href="img/favicon.ico" type="image/x-icon">
    <!-- Stylesheets-->
     <link rel="stylesheet" type="text/css" href="//fonts.googleapis.com/css?family=Shadows+Into+Light%7CLibre+Franklin:200,300,400,600,700"><link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css"><link rel="stylesheet" type="text/css" href="css/css.css"><link rel="stylesheet" type="text/css" href="css/videocontrols.css"><link rel="stylesheet" type="text/css" href="css/2.css"><link href="https://fonts.googleapis.com/icon?family=Material+Icons"
      rel="stylesheet">
  ...
  <body class="">
    ...
    <div class="text-center page">
          ...
          <nav class="rd-navbar rd-navbar-default rd-navbar-original rd-navbar-static rd-navbar--is-stuck" data-layout="rd-navbar-fixed" data-sm-layout="rd-navbar-fixed" data-sm-device-layout="rd-navbar-fixed" data-md-layout="rd-navbar-fixed" data-md-device-layout="rd-navbar-fixed" data-lg-device-layout="rd-navbar-fixed" data-xl-device-layout="rd-navbar-static" data-xxl-device-layout="rd-navbar-static" data-lg-layout="rd-navbar-fullwidth" data-xl-layout="rd-navbar-static" data-xxl-layout="rd-navbar-static" data-stick-up-clone="false" data-sm-stick-up="true" data-md-stick-up="true" data-lg-stick-up="true" data-xl-stick-up="true" data-xxl-stick-up="true" data-md-stick-up-offset="300px" data-lg-stick-up-offset="1px" data-stick-up="true">
            <div class="rd-navbar-inner">
              ...
              <div class="rd-navbar-panel">
                ...
                <!-- RD Navbar Brand-->
                <div class="rd-navbar-brand"><a class="brand-name" href="index.html"><img src="img/logo.png" alt="" width="174" height="33"></a></div>
              </div>
      ...
      <!-- Swiper-->
      <section class="section swiper-container swiper-slider swiper-container-horizontal" id="Inicio" data-loop="false" data-simulate-touch="false" data-autoplay="false"> 
        <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
          <div class="swiper-slide-video swiper-slide swiper-slide-active" data-slide-bg="img/home-slider-01.jpg" style="background-image: url(img/home-slider-01.jpg;); background-size: cover; width: 1343px;">
                ...
                <div class="row justify-content-lg-between justify-content-center">
                  <div class="col-xl-4 col-lg-5 offset-xl-1">
                    <div class="oveflow-wrapper">
                      <h5 class="big text-accent fadeInUp animated" data-caption-animate="fadeInUp" data-caption-delay="400">La Mejor Metropolis!</h5>
                    </div>
                    <div class="oveflow-wrapper">
                    ...
                    <ul class="group text-xs-nowrap">
                      <li> <a class="button button-white fadeInUp animated" href= data-caption-animate="fadeInUp" data-caption-delay="500">Galeria</a></li>
                    </ul>
                  </div>
                    ...
                    <div class="video-caption"><img class="video-caption-overlay" src="img/home.png" alt="">
                      ...
                      <div class="rd-video play-on-scroll rd-video-player" data-rd-video-path="img/managua">
                        <div class="rd-video-wrap">
                          ...
                          <video style="visibility: visible; opacity: 1;"><source type="video/mp4" src="img/managua.mp4"></video>
                          <div class="rd-video-controls">
                            ...
                            <div class="current" style="width: 0%;"></div></div>
                            ...
                            <div class="rd-video-volume-wrap">
                              ...
                              <div class="rd-video-volume-bar-wrap">
                                <!-- Volume bar-->
                                <div class="rd-video-volume-bar rd-video-volume-bar-vertical"><div class="current" style="width: 100%; height: 100%;"></div></div>
                              </div>
                            </div>
                          </div>
                        </div>
          ...
          <div class="swiper-slide swiper-slide-next" data-slide-bg="img/home-slider-02.jpg" style="background-image: url(img/home-slider-02.jpg;); background-size: cover; width: 1343px;">
            <div class="swiper-slide-caption">
              <div class="container container-wide">
                <h2 data-caption-animate="fadeInUp" data-caption-delay="300" class="not-animated">Descubre la Nueva Managua</h2>
                <h3 data-caption-animate="fadeInUp" data-caption-delay="400" class="not-animated">Recuerda la vieja Ciudad!</h3>
                <ul class="group text-xs-nowrap">
                  <li><a class="button button-white not-animated" href= data-caption-animate="fadeInUp" data-caption-delay="500">galeria</a></li>
                </ul>
              </div>
            </div>
          </div>
          <div class="swiper-slide" data-slide-bg="img/home-slider-03.jpg" style="background-image: url(index_filex/home-slider-03.jpg;); background-size: cover; width: 1343px;">
            <div class="swiper-slide-caption">
              <div class="container container-wide">
                <h2 data-caption-animate="fadeInUp" data-caption-delay="300" class="not-animated">Descubre lo maravilloso de Managua</h2>
                <ul class="group text-xs-nowrap">
                  <li><a class="button button-white not-animated" href= data-caption-animate="fadeInUp" data-caption-delay="500">Galeria</a></li>
                </ul>
              </div>
      ...
      <section class="section context-dark bg-accent section-cta">
        <div class="container container-wide">
          <div class="row row-30 align-items-center">
            ...
            <div class="col-xl-3 text-center"><a class="button button-white-style-1" target="_blank" href=>Galeria</a></div>
          </div>
        </div>
      </section>
      <section class="section-80 section-md-90 section-lg-140 bg-gray-lighter" id="Inicio">
        <div class="container">
          <!-- Text Rotator-->
          <h2>Managua <span class="text-rotator" data-text-class="text-accent-2 font-accent" data-enable="1200" data-words="... Memorable,...Conoce la,...Ama la" data-rotate-interval="3000" data-rotate-animation="fadeInUp, fadeOutUp"><span class="rotate-area fadeInUp animated text-accent-2 font-accent" style="display: inline-block; width: 405.683px;">...Memorable</span><span class="rotate-list"><span>...Memorable</span><span>...ready to use</span><span>...Memorable</span></span></span></h2>
          <div class="row row-60 justify-content-center">
            <div class="col-lg-3 col-md-5 col-sm-6"><a href="htpp://www.facebook.com/metropolismanagua"><span class="fa-3x fad fa-facebook"></span></a>
              <!-- CountTo-->
              <div class=" " data-speed=""></div>
              <h5 class="counter-title">Facebook</h5>
            </div>
            <div class="col-lg-3 col-md-5 col-sm-6"><a href="htpp://www.twitter.com/metropolismanagua"><span class="fa-3x fad fa-twitter"></span></a>
              <!-- CountTo-->
             
              <h5 class="counter-title">Twitter</h5>
            </div>
            <div class="col-lg-3 col-md-5 col-sm-6"><a href="htpp://www.instagram.com/metropolismanagua"><span class="fa-3x fad fa-instagram"></span></a>
              <!-- CountTo-->
              <div class="" data-speed=""></div>
              <h5 class="counter-title">Instagram</h5>
            </div>
            <div class="col-lg-3 col-md-5 col-sm-6"><a href="htpp://www.youtube.com/metropolismanagua"><span class="fa-3x fad fa-youtube"></span></a>
              <!-- CountTo-->
              <div class="" data-speed=""></div>
      ...
      <section class="section-80 section-md-90 section-lg-140 bg-default" id="Historia">
        <div class="container container-wide container-spacing-30">
          ...
          <div class="row row-50 row-lg-90">
            <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;"><a class="thumbnail-type-1" href="">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;"><a class="thumbnail-type-1" href="index.html">
        ...
        <div class="container container-wide container-spacing-30">
          ...
          <div class="row row-50 row-lg-90">
            ...
            <div class="col-lg-12 text-center offset-top-40" id="goal-2">
              <button class="button button-primary" data-custom-toggle="#goal, #goal-2" data-custom-toggle-disable-on-blur="true"></button>
            </div>
      ...
      <section class="section bg-gray-lighter section-60 section-md-bottom-30 section-lg-top-0 section-lg-bottom-0" id="Emprender">
        <div class="container container-wide">
          <div class="row align-items-center justify-content-center justify-content-lg-between">
            <div class="col-sm-7 col-md-5 col-lg-4 col-xxl-4 image-wrapper-3 text-xl-right d-none d-sm-block wow fadeInUp" style="visibility: hidden; animation-name: none;"><img class="image__item" src="img/emp.jpg" alt=""></div>
        ...
        <div class="container container-wide container-spacing-30">
          ...
          <div class="row row-50 row-lg-90">
            ...
            <div class="col-lg-12 text-center offset-top-40" id="">
              <button class="button button-primary" data-custom-toggle="#, #" data-custom-toggle-disable-on-blur="true"></button>
		  </div></div>
      </section>
