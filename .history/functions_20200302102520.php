...
function this_scripts_styles() {
	...
	wp_enqueue_script('core', get_template_directory_uri() . '/core.js', array(), '1.0.0',true);
	wp_enqueue_script('script', get_template_directory_uri() . '/script.js', array('core'), '1.0.0',true); 
}
