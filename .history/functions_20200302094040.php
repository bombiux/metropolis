...
function this_scripts_styles() {
	...
	wp_enqueue_script('core', get_template_directory_uri() . '/js/core.js', array('jquery'), '1.0.0');
	wp_enqueue_script('script', get_template_directory_uri() . '/js/script.js', array('core','jquery'), '1.0.0'); 
}
