...
function this_scripts() {
	...
	wp_enqueue_script('rd-navbar', 'https://cdn.jsdelivr.net/gh/ZemezPlugins/rd-navbar@master/dist/js/jquery.rd-navbar.min.js', array('jquery'), '1.4.1', true);
	wp_enqueue_script('swiper', 'https://cdnjs.cloudflare.com/ajax/libs/Swiper/3.4.2/js/swiper.jquery.min.js', array('jquery'), '1.4.1', true);
	wp_enqueue_script('wow', 'https://cdnjs.cloudflare.com/ajax/libs/wow/1.1.2/wow.min.js', array('jquery'), '1.4.1', true);
	
	wp_enqueue_script('rdVideoPlayer', get_stylesheet_uri(), array('gFonts', 'bootstrap', 'fa'), '1.0.0');
