...
function this_scripts() {
	...
	wp_enqueue_script('cMigrate', 'https://cdnjs.cloudflare.com/ajax/libs/jquery-migrate/3.1.0/jquery-migrate.min.js', array('jquery3'), '3.1.0');
	wp_script_add_data( 'jquery3', array( 'integrity', 'crossorigin' ) , array( 'sha256-CSXorXvZcTkaix6Yvo6HppcZGetbYMGWSFlBw8HfCJo=', 'anonymous' ) );
	...
	wp_enqueue_script('script', get_template_directory_uri() . '/js/script.js', array('jquery3', 'cMigrate', 'easing', 'uiToTop', 'rdnavbar', 'swiper', 'wow', 'rdvideoPlayer', 'textRotator'), '0.0.1', true);
