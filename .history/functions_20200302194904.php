...
function this_scripts() {
	...
	wp_script_add_data('jquery3', 'integrity', 'crossorigin' ) , array( 'sha256-CSXorXvZcTkaix6Yvo6HppcZGetbYMGWSFlBw8HfCJo=', 'anonymous'));
	...
	wp_script_add_data('easing', array( 'integrity', 'crossorigin' ) , array( 'sha256-H3cjtrm/ztDeuhCN9I4yh4iN2Ybx/y1RM7rMmAesA0k=', 'anonymous'));
	...
	wp_script_add_data('swiper', array( 'integrity', 'crossorigin' ) , array( 'sha256-Pl63iFzVinaVFc3QqrQvq3DimF1feP6Wqekm5jTabXo=', 'anonymous'));
	
	wp_enqueue_script('wow', 'https://cdnjs.cloudflare.com/ajax/libs/wow/1.1.2/wow.min.js', array('jquery3'), '1.1.2', true);
	wp_script_add_data('wow', array( 'integrity', 'crossorigin' ) , array( 'sha256-z6FznuNG1jo9PP3/jBjL6P3tvLMtSwiVAowZPOgo56U=', 'anonymous'));
