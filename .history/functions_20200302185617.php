...
function this_scripts() {
	...
	wp_enqueue_script('script', get_template_directory_uri() . '/js/script.js', array('jQuery', 'migrate', 'easing', 'uiToTop', 'rdnavbar', 'swiper', 'wow', 'rdvideoPlayer', textro), '0.0.1', true);
