...
<body>
  ...
  <div style="display:block;width:100%;padding:5px 0;background:url(https://fundeu.es/coronavirus-recomendaciones-lenguaje/images/covid.png) left no-repeat">
    ...
    <div style="display:flex;flex-direction:column;width:300px;margin:auto;text-align:center;font-weight:bold">
      <div style="text-transform:uppercase">Nicaragua</div>
      <div style="display:flex;justify-content:space-between">
        <div style="display:flex;flex-direction:column">
          <div style="color:red">Contagiados</div>
        ...
        <div style="display:flex;flex-direction:column">
          <div style="color:black">Víctimas</div>
